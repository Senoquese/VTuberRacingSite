...
/** @type {string} */
const CACHE_VERSION = '1758490179|17233334941';
/** @type {string} */
const CACHE_PREFIX = 'The Chilla Races-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'chillaProfileTest.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["chillaProfileTest.html","chillaProfileTest.js","chillaProfileTest.offline.html","chillaProfileTest.icon.png","chillaProfileTest.apple-touch-icon.png","chillaProfileTest.audio.worklet.js","chillaProfileTest.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["chillaProfileTest.wasm","chillaProfileTest.pck"];
