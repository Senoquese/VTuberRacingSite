...
/** @type {string} */
const CACHE_VERSION = '1757626918|3202440147';
/** @type {string} */
const CACHE_PREFIX = 'The Chilla Races-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'chillaWeb.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["chillaWeb.html","chillaWeb.js","chillaWeb.offline.html","chillaWeb.icon.png","chillaWeb.apple-touch-icon.png","chillaWeb.audio.worklet.js","chillaWeb.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["chillaWeb.wasm","chillaWeb.pck"];
